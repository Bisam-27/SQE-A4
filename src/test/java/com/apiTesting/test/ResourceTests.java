...
public class ResourceTests {
    ...
    public void testGetResources() {
        Response response = ResourceApi.getResources(1); 
        ApiTestHelper.assertStatusCode(response, 200);
    }

    @Test
    public void testGetSingleResource() {
        Response response = ResourceApi.getResourceById(2); 
        ApiTestHelper.assertStatusCode(response, 200);
    }
    ...
    public void testUpdateResource() {
        Resource updatedResource = new Resource("Updated Resource", "HR Manager");
